...
# Phase 3 - Main function and while loop
def main():
    #global variables 
    global game_over, snake, growth #add growth in phase 4
    ...
    while game_over is False:
        ...
        check_apple(head) # add phase 4
        
        #check to see if snake is growing, if so let it grow
        if growth > 0: # add phase 4
            growth -= 1 # add phase 4
